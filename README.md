...
**_Note:_** Documentation for the client can be found [here.](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/client.md)
...
| HttpClientConfiguration | [`Action<HttpClientConfiguration.Builder>`](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-client-configuration-builder.md) | Action delegate that configures the HTTP client by using the HttpClientConfiguration.Builder for customizing API call settings.<br>*Default*: `new HttpClient()` |
...
* [Simple Calculator](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/controllers/simple-calculator.md)

## SDK Infrastructure

### Configuration

* [HttpClientConfiguration](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-client-configuration.md)
* [HttpClientConfigurationBuilder](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-client-configuration-builder.md)
* [ProxyConfigurationBuilder](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/proxy-configuration-builder.md)

### HTTP

* [HttpCallback](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-callback.md)
* [HttpContext](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-context.md)
* [HttpRequest](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-request.md)
* [HttpResponse](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-response.md)
* [HttpStringResponse](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/http-string-response.md)

### Utilities

* [ApiException](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/api-exception.md)
* [ApiHelper](https://www.github.com/ZahraN444/repoghnet/tree/3.21.2/doc/api-helper.md)
